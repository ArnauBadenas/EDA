...
import registers.DifferentOwnerException;
import registers.DogRegister;
import registers.DogRegisterImp;
import registers.UnknownOwnerException;
...
import static utilsProva.UtilsProva.SORTIR;
import static utilsProva.UtilsProva.finalitzar;
import static utilsProva.UtilsProva.informar;
import static utilsProva.UtilsProva.notificarError;
import static utilsProva.UtilsProva.notificarExcepcio;
...
public class TestPurposeOwners {
    public static void main (String [] args) {
        ...
        try{
            SortedSet<String> cosa = wr.findPurposeOwners(DogPurpose.HUNTING);
            if(!cosa.equals(new TreeSet<>())){
